    ...
    <div className="h-screen p-8">
      <div className="flex flex-col md:flex-row">
        <div className="md:w-1/3 p-4 flex gap-5 flex-col justify-center">
          <h1 className="text-blue-950 text-center md:text-start font-bold text-3xl md:text-7xl mb-4">Best Seller Products</h1>
          ...
          <button className="bg-white border border-black w-40 rounded-lg p-2 hover:bg-blue-950 hover:text-white transition duration-200 ease-in-out">Shop Now</button>
        </div>
        <div className="md:w-2/3  flex overflow-x-scroll space-x-4">
